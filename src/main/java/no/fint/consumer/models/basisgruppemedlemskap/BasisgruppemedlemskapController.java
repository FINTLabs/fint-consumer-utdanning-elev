...
public class BasisgruppemedlemskapController {
    ...
    public BasisgruppemedlemskapResources getBasisgruppemedlemskap(
        ...
        List<BasisgruppemedlemskapResource> basisgruppemedlemskap;
        if (sinceTimeStamp == null) {
            basisgruppemedlemskap = cacheService.getAll(orgId);
        } else {
            basisgruppemedlemskap = cacheService.getAll(orgId, sinceTimeStamp);
        }

        fintAuditService.audit(event, Status.CACHE_RESPONSE, Status.SENT_TO_CLIENT);

        return linker.toResources(basisgruppemedlemskap);
    }
    ...
    public BasisgruppemedlemskapResource getBasisgruppemedlemskapBySystemId(
        ...
        if (cacheService != null) {
            ...
            return linker.toResource(basisgruppemedlemskap);
        }    
    }
