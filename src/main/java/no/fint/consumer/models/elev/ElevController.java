    ...
    public ResponseEntity getStatus(
        ...
        switch (event.getResponseStatus()) {
            case ACCEPTED:
                ...
                result = objectMapper.convertValue(event.getData(), objectMapper.getTypeFactory().constructCollectionType(List.class, ElevResource.class));
